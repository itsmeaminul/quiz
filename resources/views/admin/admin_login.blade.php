      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block b p-5">
					<!-- <div class="sidebar-brand-text mx-3 h1 font-weight-bold"> <i class="fas fa-laugh-wink"></i> ADMIN PANEL </div>
					<span class="h1 font-weight-bold">of <br>Online Quiz Contest-2020</span> -->
					<img src="/images/competition.jpg" width="400" height="400">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4 font-weight-bold">Please Login!</h1>
                  </div>
                  <form class="user" method="POST" action="{{URL::to('admin.login')}}">
                    ...
                    <!-- <a href="#" type="subm" class="btn btn-primary btn-user btn-block">
