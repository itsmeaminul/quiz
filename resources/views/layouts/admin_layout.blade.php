	...
	<body>
		<div class="fix main">
			<div class="col-sm d-flex justify-content-right ml-5 mt-2">	
				<img src="/images/welcome.png" class="ml-5 pl-5">
			</div>
			<div class="fix slider">
				<div class="slider-wrapper theme-dark" >
					<div class="nivoSlider" id="slider">
						<img src="images/nemo.jpg" title="The site Developed by Md. Aminul Islam"/>
						<img src="images/toystory.jpg" title=""/>
						<img src="images/up.jpg" title=""/>
						<img src="images/walle.jpg" title="#htmlcaption"/>
					</div>
				</div>
				<div class="nivo-html-caption" id="htmlcaption">
					<p>This is a Caption. This is <a href="http://wikipedia.org">link</a></p>
				</div>
			</div>
