		...
		<div id="wrapper">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<li class="nav-item active">
					...
					<li class="nav-item">
						<a class="nav-link collapsed h3" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
							<i class="far fa-question-circle"></i>
							<span>Questions</span>
						</a>
						<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
							<div class="bg-white py-2 collapse-inner rounded">
								<a class="collapse-item" href="{{URL::to('/set_question')}}">Set Question</a>
								<a class="collapse-item" href="{{URL::to('/all_question')}}">All Question</a>
							</div>
						</div>
					</li>
					<!-- Nav Item - Participents -->
					<li class="nav-item">
						<a class="nav-link" href="{{URL::to('/total_participents')}}">
							...
							<footer class="sticky-footer bg-success text-white">
								<div class="container my-auto">
									<div class="copyright text-center my-auto">
										<span class="h6 font-weight-bold">Copyright &copy; Online Quiz Contest 2020</span>
									</div>
								</div>
							</footer>
							<!-- End of Footer -->
